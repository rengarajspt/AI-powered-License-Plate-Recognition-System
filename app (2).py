        ...
        for r in results:
            ...
            for box in boxes:
                ...
                if plate_text:
                    ...
                    st.markdown(f"""  <div class="result-card"> <h1>𝗟𝗶𝗰𝗲𝗻𝘀𝗲 𝗣𝗹𝗮𝘁𝗲 𝗡𝘂𝗺𝗯𝗲𝗿</h1> <img src="data:image/jpg;base64,{img_base64}" style="width:220px;margin:10px;border-radius:8px;">
<h1 style="color:#FFD700; font-weight:900; letter-spacing:3px;">{plate_text} </h1> </div> """, unsafe_allow_html=True )
